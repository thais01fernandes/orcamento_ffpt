...
## Média populacional das cidades que em que o gasto aumentou e diminuiu
...
## Média de linhas de ônibus das cidades que em que o gasto aumentou e diminuiu
...
## Gráfico da relação Linhas de ônibus e Gasto com Transporte Público
...
## Gráfico da relação Tamanho da População e Gasto com Transporte Público
...
todas_cidades_2_1 %>% 
  ...
  ggtitle( "") +
  coord_flip() +
  geom_label(aes(x = Cidade, y = População.x, label = População.x), family = "serif", face = "bold", size = 4) +
  theme(plot.title = element_text(family = "serif", size = 13, face = "bold", hjust = 0.9, colour = "black"),
    text = element_text(family = "serif"),
    axis.text.x=element_blank(),
    axis.text.y=element_text(size = 12, family = "serif"),
